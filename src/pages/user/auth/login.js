...
export default function LogIn(props) {
    ...
    const formik = useFormik({
        ...
        onSubmit:async values => {
            ...
            await dispatch(Actions.loginUserSaga(values.email, values.password, router));
                ...
                <Container>
                    <Row className="justify-content-center">
                        ...
                        <div className="mt-5 text-center">
                            <p> Don't have an account? <Link href="/user/auth/register" className="font-weight-medium text-primary" passHref> Signup now </Link> </p>
