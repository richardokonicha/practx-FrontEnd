...
import { Container, Nav, NavItem, NavLink, TabContent, TabPane, Row, Col, Card, CardBody, FormGroup, Alert, Form, Input, Button, FormFeedback, Label, InputGroup, InputGroupAddon } from 'reactstrap';
...
export default function LogIn(props) {
    ...
    const formik = useFormik({
        ...
        onSubmit:async values => {
			...
			await dispatch(Actions.loginRootUser(values.email, values.password, router));
